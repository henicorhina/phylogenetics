...
/Users/mharvey/src/plink_mac_20190304/plink --vcf vcf_files_final/${species}_SNPs_phased_rmIndels_75_QC_DP_random.recode.vcf --const-fid --allow-extra-chr --recode structure --out structure_files_all_sites/${species}_structure.str
